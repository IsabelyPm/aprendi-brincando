...
const Index = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#FFFDF6] overflow-x-hidden selection:bg-rose-200 text-slate-700 relative pb-12">
      ...
      {/* 1. TEXTURA DE FUNDO INFANTIL: BOLINHAS COLORIDAS MAIS DIRETAS */}
      ...
      {/* 2. CONFETES E LETRINHAS MÁGICAS FLUTUANDO NAS LATERAIS (PREENCHE O VAZIO) */}
      ...
      <header className="absolute top-0 inset-x-0 z-30">
        <nav className="container flex items-center justify-between py-6">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-black text-slate-600">
            ...
            <a href="/plataforma" className="hover:text-rose-500 transition-colors">Jogar Agora</a>
        ...
        <div className="container grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="text-left">
            ...
            <p className="mt-6 max-w-lg text-lg text-slate-500 font-bold leading-relaxed">
              Um espaço aberto para crianças treinarem a leitura e escrita através de jogos interativos 
          ...
          {/* Lado Direito - O Moranguinho em Destaque na Bolha de Sabão */}
          <div className="relative flex justify-center items-center min-h-[460px]">
            {/* Super Efeito de Bolha de Sabão Mágica de Fundo */}
            <div
              ref={blobRef}
      ...
      {/* Seção Pilares - Cards Estilo Bloquinhos de Brinquedo de Madeira/Acrílico */}
      ...
      {/* Simulador de Dashboard Estilo Cápsula Espacial / Vidro Acrílico */}
      <section id="dashboard" className="py-24 bg-gradient-to-b from-[#32131C] to-[#1D080E] relative overflow-hidden rounded-[60px] mx-4 my-12 border-4 border-[#4A202C]">
        ...
        <div className="container relative z-10">
          ...
          {/* Painel do Dashboard com Estilo de Vidro/Borda Grossa */}
          <div className="max-w-4xl mx-auto rounded-[44px] bg-white p-6 md:p-10 shadow-[0_20px_0_rgba(0,0,0,0.3)] border-4 border-slate-100">
            ...
            {/* Barra de Progresso Estilo Máquina de Chiclete */}
            ...
            {/* Rosquinhas de Progresso Redondas e Lindas */}
            ...
            {/* Vitrine de Medalhas estilo Chiclete/Gelatina (Gummy Effect) */}
      ...
      {/* Seção de Redirecionamento para PDFs (Estilo Costura de Caderno Pedagógico) */}
      <section id="pdfs" className="py-24 relative z-10">
        <div className="container mx-auto px-4">
          ...
          {/* Cards com Bordas Tracejadas Fortes e Sombra de Peça de Tabuleiro */}
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              >
                ...
                <a 
                  href={`/materiais?categoria=${item.id}`} 
      ...
      {/* Caixa de Ação Final Metamórfica */}
